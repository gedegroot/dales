  ...
  subroutine getobl
        ...
        do j=2,j1
          ...
          if (Rib == 0) then
             ...
             do while (.true.)
                ...
                if(iter > 1000) stop 'Obukhov length calculation does not converge for isurf=2!'
             end do
    ...
    if (Rib == 0) then
       ...
       do while (.true.)
          ...
          if(abs((L - Lold)/L) < 1e-4) exit
          if(iter > 1000) stop 'Obukhov length calculation does not converge in isurf=2!'
       end do
